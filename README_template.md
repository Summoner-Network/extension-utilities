...
This repository is an **extension template** for building Python and Rust projects that integrate with [Summoner's core codebase](https://github.com/Summoner-Network/summoner-core) for client/server communication.
